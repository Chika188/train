              ...
              <div
                ...
                onClick={() => {
                  if (step.description === 'Battle' && isSubmitted && isSubmitted2) {
                    ...
                    const player1Str = btoa(encodeURIComponent(JSON.stringify(player1)));
                    const player2Str = btoa(encodeURIComponent(JSON.stringify(player2)));
                    navigate(`/battle-result?player1=${player1Str}&player2=${player2Str}`);
                  }
                }}
              >
                <FontAwesomeIcon
                  ...
                  style={{
                    color:
                      step.description === 'Battle' && isSubmitted && isSubmitted2
                        ? '#ff0000'
                        : step.color,
                    width: '8vw',
                    height: '8vw',
            ...
            <div className='player-content-item'>
              ...
              <div className='player-info'>
                ...
                <button
                  ...
                  style={{ cursor: !username1 || isSubmitted ? 'not-allowed' : 'pointer' }}
                  disabled={!username1 || isSubmitted}
                  onClick={() => {
                    handleSubmit(username1, '1');
                  }}
                >
              ...
              {avatarUrl1 && (
                <div className='play-info-image'>
                  ...
                  <span className='remove-avatar' onClick={() => handleRemoveAvatar('1')}>
                    ×
                  </span>
                </div>
              )}
            ...
            <div className='player-content-item'>
              ...
              {avatarUrl2 && (
                <div className='play-info-image'>
                  ...
                  <span className='remove-avatar' onClick={() => handleRemoveAvatar('2')}>
                    ×
                  </span>
                </div>
              )}
